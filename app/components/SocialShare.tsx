...
export function SocialShare({ title, url }: ShareProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <span className="text-xs font-medium text-white/50 mr-1">Partager</span>
      ...
      <button
        onClick={handleCopy}
        className="inline-flex h-9 items-center gap-1.5 rounded-xl border border-white/10 bg-white/5 px-3 text-xs text-white/60 transition hover:bg-white/10 hover:text-white"
